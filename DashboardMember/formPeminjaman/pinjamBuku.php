...
$nisnSiswa = $_SESSION["member"]["nim"];
$dataSiswa = queryReadData("SELECT * FROM member WHERE nim = $nisnSiswa");
...
<body>
      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="semester" class="form-control" placeholder="semester" aria-label="semester" aria-describedby="basic-addon1" value="<?php echo htmlentities($_SESSION["member"]["semester"]); ?>" readonly>
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Jurusan</span>
            <input type="text" name="jurusan" class="form-control" placeholder="jurusan" aria-label="jurusan" aria-describedby="basic-addon1" value="<?php echo htmlentities($_SESSION["member"]["jurusan"]); ?>" readonly>
          </div>
  ...
  <footer class="shadow-lg bg-subtle p-3">
    <div class="container-fluid d-flex justify-content-between">
      <p class="mt-2">Created by <span class="text-primary"> bilker29</span> © 2025</p>
