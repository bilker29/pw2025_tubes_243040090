...
$dataPinjam = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul, peminjaman.nim, member.nama, admin.nama_admin, peminjaman.tgl_pinjam, peminjaman.tgl_kembali, peminjaman.status
FROM peminjaman
