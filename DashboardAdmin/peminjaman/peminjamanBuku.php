...
$dataPeminjam = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul, peminjaman.nim, member.nama, member.semester, member.fakultas, peminjaman.id_admin,  peminjaman.tgl_peminjaman, peminjaman.tgl_pengembalian 
FROM peminjaman 
        ...
        <table class="table table-striped table-hover">
          <thead class="text-center">
            <tr>
              ...
              <th class="bg-primary text-light">Nama Mahasisiwa</th>
          ...
          <?php foreach ($dataPeminjam as $item) : ?>
            <tr>
              ...
              <td><?= $item["nama"]; ?></td>
              <td><?= $item["semester"]; ?></td>
              <td><?= $item["fakultas"]; ?></td> <!-- Perbaiki di sini -->
              <td><?= $item["id_admin"]; ?></td>
