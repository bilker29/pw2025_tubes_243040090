...
$dataPeminjam = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, buku.kategori, pengembalian.nim, member.nama, member.semester, member.fakultas, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
        ...
        <table class="table table-striped table-hover">
          <thead class="text-center">
            <tr>
              ...
              <th class="bg-primary text-light">Nism</th>
