...
$query = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul, peminjaman.nim, member.nama, member.semester, member.jurusan, peminjaman.id_admin, peminjaman.tgl_peminjaman, peminjaman.tgl_pengembalian
FROM peminjaman
        ...
        <?php foreach ($query as $item) : ?>
          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" placeholder="Nama Mahasisiwa" name="nama" id="nama" value=" <?= $item["nama"]; ?>" readonly>
            </div>
            <div class="mb-3">
